...
public class ManagerTestHelper extends DefaultDataTestHelper {
	...
	public static final int DEFAULT_XMPP_TIMEOUT = 5000;
	protected ManagerXmppComponent managerXmppComponent;
	protected ComputePlugin computePlugin;
	protected StoragePlugin storagePlugin;
	protected IdentityPlugin identityPlugin;
	...
	protected AccountingPlugin computeAccountingPlugin;
	protected AccountingPlugin storageAccountingPlugin;
	protected FederationMemberPickerPlugin memberPickerPlugin;
	protected Token defaultFederationToken;
	protected Map<String, Map<String, String>> defaultFederationAllUsersCrendetials;
	protected Map<String, String> defaultFederationUserCrendetials = new HashMap<String, String>();
	protected FakeXMPPServer fakeServer = new FakeXMPPServer();
	protected ScheduledExecutorService executorService;
	
	protected final String CPU_IDLE = "1";
	protected final String CPU_INUSE = "2";
	protected final String MEM_IDLE = "1000";
	protected final String MEM_INUSE = "2000";
	protected final String INSTANCES_IDLE = "5";
	protected final String INSTANCES_INUSE = "10";
